        ...
        axios.get("https://www.apnews.com/apf-topnews").then(response => {
            ...
            $(".FeedCard").each((i, element) => {
                ...
                if (headline && articleLink && summary) {
                    console.log(1);
                    db.Article.updateOne({ headline: $(element).find("h1").text(), articleLink: $(element).find("h1").text() }, result, { upsert: true })
                        .then(dbArticles => {
        ...
        axios.get("https://www.apnews.com/apf-topnews").then(response => {
            ...
            $(".FeedCard").each((i, element) => {
                ...
                if (headline && tag && articleLink && summary) {
                    db.Article.updateOne({'articleLink': articleLink, headline: $(element).find("h1").text() }, result, { upsert: true })
                        .then(dbArticles => {
                            // View the added articles in the console
                            console.log(dbArticles);
                        })
